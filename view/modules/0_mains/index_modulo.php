...
<body class="">
  ...
  <div class="card  p-2 border-dark">
    ...
    <img src="assets/img/usuario.png" class="card-img-top iconos " alt="...">
      <ul >
      	...
      	<ol><a class="btn btn-outline-dark" href="">Darse de Baja</a></ol>
      </ul>
    </div>
  ...
  <div class="card  p-2 border-dark">
    ...
    <img src="assets/img/productos.png" class="card-img-top iconos " alt="...">
      <ul>
      	<ol><a class="btn btn-outline-dark" href="">Registrar Productos</a></ol>
      	<ol><a class="btn btn-outline-dark" href="">Consultar Productos</a></ol>
      </ul>
    </div>
  ...
  <div class="card  p-2 border-dark">
    ...
    <img src="assets/img/pedidos.png" class="card-img-top iconos " alt="...">
     <ul>
     	<ol><a class="btn btn-outline-dark" href="">Registrar Pedido</a></ol>
     	<ol><a class="btn btn-outline-dark" href="">Consultar Pedido</a></ol>
     </ul>
    </div>
...
<div class="card-deck">
  <div class="card  p-2 border-dark">
    ...
    <img src="assets/img/domicilio.jpg" class="card-img-top iconos " alt="...">
      <ul>
      	<ol><a class="btn btn-outline-dark" href="">Registrar Entrega</a></ol>
      	<ol><a class="btn btn-outline-dark" href="">Asignar Domicilio</a></ol>
      	<ol><a class="btn btn-outline-dark" href="">Consultar Domicilio</a></ol>
      </ul>
    </div>
